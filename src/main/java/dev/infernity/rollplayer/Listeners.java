...
import dev.infernity.rollplayer.listeners.debug.DebugCommand;
...
public class Listeners {
    ...
    public Listeners() {
        this.listeners = List.of(new Test(), new TestArguments(), new EightBall(), new Choose(), new TicTacToe(), new DebugCommand());
